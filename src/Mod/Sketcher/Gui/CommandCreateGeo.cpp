...
public:
   ...
   public:
        virtual void registerPressedKey(bool pressed, int key)
    {
        ...
        else{ //if no key is presses line mode is the default
            LineMode= LINE_MODE_Line;
    ...
    virtual bool releaseButton(Base::Vector2D onSketchPos){
        ...
        if (Mode==STATUS_LINE_Do || Mode==STATUS_LINE_Close||Mode==STATUS_ARC_Do || Mode==STATUS_ARC_Close ||Mode==STATUS_TAN_LINE_Do || Mode==STATUS_TAN_LINE_Close  )
        {

            if (Mode==STATUS_LINE_Do || Mode==STATUS_LINE_Close ||Mode==STATUS_TAN_LINE_Do || Mode==STATUS_TAN_LINE_Close)
            {
            ...
            else if (Mode==STATUS_ARC_Do || Mode==STATUS_ARC_Close )
